...
const MovieDetails = ({ movieId, onMovieClick, onClose }) => {
  ...
  if (!movie) {
    return <div className="text-center">{t.movieNotFound}</div>
  }
    ...
    >
      ...
      <div className="p-6 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="mb-6">
            <h3 className="text-2xl font-semibold mb-2">{t.cast}</h3>
          ...
          {relatedMovies.length > 0 && (
            <div>
              <h3 className="text-2xl font-semibold mb-2">{t.relatedMovies}</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {relatedMovies.map(relatedMovie => (
                  ...
                  >
                    ...
                    />
                    <p className="font-semibold text-sm">{relatedMovie.title}</p>
                  </div>
                ))}
              </div>
            </div>
